...
>
> **与现有规范的关系**: 本规约与 `testing.md`（通用测试策略）和 `java.md`（Java 编码规范）协同使用，专注于 Spring Boot Repository 层的测试实践
...
- **通用测试策略**: 参考 `testing.md` 了解测试金字塔、AAA 模式等通用测试原则
- **Java 编码规范**: 参考 `java.md` 了解 Java 编码规范、Lombok 使用等
- **代码质量标准**: 参考 `quality.md` 了解代码质量要求和自检清单
- **安全规范**: 参考 `security.md` 了解测试中的安全考虑

---

**重要**: 
- 本规约专注于 Spring Boot Repository 层的单元测试编写
- 与 `testing.md`（通用测试策略）和 `java.md`（Java 编码规范）协同使用
