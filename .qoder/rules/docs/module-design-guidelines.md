...
| 📘 [七要素详细规范](./module-seven-elements.md) | 第3-9章：背景、角色、模型、流程、状态、接口、数据 | 详细设计阶段 |
| 📙 [质量保障指南](./module-quality-assurance.md) | 第10-15章：NFR、监控、安全、风险 | 质量评审阶段 |
| 📕 [工程实践指南](./module-engineering-practices.md) | 第16-24章：技术债、评审、演进、快速指南 | 工程实践阶段 |
...
3. **学习七要素**（1小时）：阅读[七要素详细规范](./module-seven-elements.md)
4. **实践应用**（按需）：参考[工程实践指南](./module-engineering-practices.md)

#### 有经验的设计者
- **快速参考**：使用[工程实践指南](./module-engineering-practices.md)第23章快速填写指南
- **深入特定领域**：根据需要查阅对应文档
- **评审检查**：使用[工程实践指南](./module-engineering-practices.md)第18章和第21章

#### 评审者
- **设计评审**：使用主文档第0.8节检查清单
- **文档质量评审**：使用[工程实践指南](./module-engineering-practices.md)第18章
- **风险评估**：关注[质量保障指南](./module-quality-assurance.md)
...
> **详细内容请参考**：[七要素详细规范](./module-seven-elements.md)
...
1. **详细设计阶段** → 查看[七要素详细规范](./module-seven-elements.md)
2. **质量评审阶段** → 查看[质量保障指南](./module-quality-assurance.md)
3. **工程实践阶段** → 查看[工程实践指南](./module-engineering-practices.md)
