...
参考：`module-design-guidelines.md`（完整版模板）
...
- **完整版架构**: 升级参考 `module-design-guidelines.md`
- **架构决策**: 关键决策记录到 `adr-template.md`
- **功能规格**: 详细功能说明参考 `feature-specification-guidelines.md`
- **文档规范**: 遵循 `document.md` 的通用要求
- **代码规范**: 实施时遵循 `coding-standards.md`
