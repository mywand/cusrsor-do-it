...
| 文档 | 内容 |
|------|------|
| 📖 [主文档](./module-design-guidelines.md) | 核心设计原则、文档概述、七要素框架 |
| 📘 **当前文档** | 第3-9章：背景、角色、模型、流程、状态、接口、数据 |
| 📙 [质量保障指南](./module-quality-assurance.md) | 第10-15章：NFR、监控、安全、风险 |
| 📕 [工程实践指南](./module-engineering-practices.md) | 第16-24章：技术债、评审、演进、快速指南 |
...
#### 聚合设计原则
> 参考[主文档](./module-design-guidelines.md)第0.2节 DDD原则
...
### 6.4 并发与竞态处理
> 参考[主文档](./module-design-guidelines.md)第0.5节 并发与性能设计原则
...
#### RESTful 设计原则
> 参考[主文档](./module-design-guidelines.md)第0.3节 API设计原则
...
### 9.1 数据建模原则
> 参考[主文档](./module-design-guidelines.md)第0.4节 数据建模原则
...
1. **质量评审** → 查看[质量保障指南](./module-quality-assurance.md)
2. **工程实践** → 查看[工程实践指南](./module-engineering-practices.md)
3. **设计原则回顾** → 返回[主文档](./module-design-guidelines.md)
