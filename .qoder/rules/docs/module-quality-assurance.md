...
### 12.1 指标监控（RED 方法）
> 参考[主文档](./module-design-guidelines.md)第0.6节 可观测性设计原则
...
### 12.4 日志规范
> 参考[主文档](./module-design-guidelines.md)第0.6节 日志分级原则
...
### 13.1 认证与授权
> 参考[主文档](./module-design-guidelines.md)第0.7节 安全设计原则
...
### 13.3 安全威胁防护
> 参考[主文档](./module-design-guidelines.md)第0.7节 常见安全威胁与防护
...
1. **工程实践** → 查看[工程实践指南](./module-engineering-practices.md)
2. **设计原则回顾** → 返回[主文档](./module-design-guidelines.md)
3. **七要素设计** → 返回[七要素详细规范](./module-seven-elements.md)
