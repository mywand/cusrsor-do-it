...
| 📘 [七要素详细规范](./module-seven-elements.md) | 第3-9章：背景、角色、模型、流程、状态、接口、数据 |
...
**如果未来需要状态管理，请参考：**
- [七要素详细规范](./module-seven-elements.md)第7.1节 状态机设计原则
- `architecture-guidelines.md` 第X章 状态管理规范
```
...
| **领域专家** | 业务逻辑正确性 | [七要素详细规范](./module-seven-elements.md)第5章 模型、第7章 状态机 |
| **技术架构师** | 架构原则遵循性 | [主文档](./module-design-guidelines.md)第0章 设计原则、[七要素详细规范](./module-seven-elements.md)第9章 数据设计 |
| **安全专家** | 安全风险 | [质量保障指南](./module-quality-assurance.md)第13章 安全控制 |
| **运维/SRE** | 可运维性 | [质量保障指南](./module-quality-assurance.md)第12章 可观测性、第14章 发布策略 |

### 21.3 评审检查清单
**使用第18章自检清单作为基础，额外关注：**
- [ ] 是否有明显的设计反模式？（参考第19章）
- [ ] 是否与系统架构冲突？（参考第20章）
- [ ] 是否有未缓解的高风险？（参考[质量保障指南](./module-quality-assurance.md)第15章）
- [ ] 是否有计划的技术债？（参考第16章）
